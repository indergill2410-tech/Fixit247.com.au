...
export default function HeroLeft() {
  return (
    <div className="flex flex-col justify-end pb-4">
      ...
      <div className="mt-10 flex max-w-4xl items-center rounded-2xl border border-white/20 bg-slate-700/35 p-2 backdrop-blur">
        <div className="flex flex-1 items-center gap-3 px-4 text-zinc-100">
          <span className="text-yellow-400">📍</span>
          <span className="text-3xl font-semibold">Your suburb</span>
          <span className="text-3xl text-zinc-300">e.g. Bondi, 2026</span>
        </div>
        <button className="rounded-xl bg-yellow-400 px-8 py-4 text-3xl font-bold text-zinc-900 hover:bg-yellow-300">Find tradies</button>
      </div>

      <div className="mt-8 flex flex-wrap gap-4">
        <Link href="/signup" className="inline-flex items-center gap-3 rounded-xl bg-yellow-400 px-7 py-4 text-3xl font-bold text-zinc-900">
